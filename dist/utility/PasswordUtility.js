...
const GenerateSignature = (paylod) => __awaiter(void 0, void 0, void 0, function* () {
    return jsonwebtoken_1.default.sign(paylod, config_1.APP_SECRET, { expiresIn: '1d' });
});
exports.GenerateSignature = GenerateSignature;
const ValidateSignature = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const signature = req.get("Authorization");
    if (signature) {
        const paylod = yield jsonwebtoken_1.default.verify(signature.split(' ')[1], config_1.APP_SECRET);
        req.user = paylod;
        return true;
    }
    return false;
